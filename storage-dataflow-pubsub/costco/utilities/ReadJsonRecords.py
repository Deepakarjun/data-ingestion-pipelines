...
#                             yield (path, rec)
#                         else:
#                             yield TaggedOutput("invalidJson", (path, json.dumps(rec, ensure_ascii=False), "array item not object"))
#                 else:
...
#                             yield (path, rec)
#                         else:
#                             yield TaggedOutput("invalidJson", (path, line, f"line {i}: not a JSON object"))
#                     except Exception as je:
#                         yield TaggedOutput("invalidJson", (path, line, f"line {i}: {je}"))
#         except Exception as e:
#             yield TaggedOutput("invalidJson", (path, "", f"read failure: {e}"))
